...
(
    ...
    dept_name character varying(35) COLLATE pg_catalog."default" NOT NULL,
...
(
    ...
    title character varying(35) COLLATE pg_catalog."default" NOT NULL,
...
ALTER TABLE IF EXISTS public.dept_manager
    ...
    ON DELETE NO ACTION
    NOT VALID;
CREATE INDEX IF NOT EXISTS fki_dept_no
...
ALTER TABLE IF EXISTS public.dept_manager
    ...
    ON DELETE NO ACTION
    NOT VALID;
CREATE INDEX IF NOT EXISTS fki_emp_no
...
ALTER TABLE IF EXISTS public.employees
    ...
    ON DELETE NO ACTION
    NOT VALID;
CREATE INDEX IF NOT EXISTS fki_emp_title_id
    ON public.employees(emp_title_id);
